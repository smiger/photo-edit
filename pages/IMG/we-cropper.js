...
!function(e, o) {
    ...
    return w.prototype.init = function() {
        ...
        void 0 === s && (s = a), t.updateCanvas = function() {
            ...
            void 0 === t && (t = function() {}), m.convertToBMP({
                canvasId: o,
                x: c,
                y: u,
                width: d,
            ...
            switch (i) {
              case "[object Object]":
                ...
                wx.canvasToTempFilePath({
                    ...
                    width: d,
                    height: s,
                    destWidth: d * f / (10 * n) * 2,
                    destHeight: s * f / (10 * n) * 2,
                    success: function(o) {
        ...
        t.src && (t.__oneTouchStart = function(e) {
            ...
            t.newScale = x(n, r, i, e, o), t.newScale <= 1 && (t.newScale = 1), t.newScale >= a && (t.newScale = a), 
